...
console.log("this.state5", translateOrigin)
    // Animated.parallel([
...
console.log("this.state6", this.state)
...
console.log("contentSizeAvailable", contentSizeAvailable)
    return (
      <TouchableWithoutFeedback onPress={() => this.props.onClose()}>
        <View style={[styles.container, contentSizeAvailable && styles.containerVisible ]}>
          ...
          <Animated.View style={[styles.popover, {
            ...
            <Animated.View ref='content' onLayout={(e) => this.measureContent(e)} style={[contentStyle,this.props.contentStyle,]}>
              {this.props.children}
            </Animated.View>
          </Animated.View>
        </View>
